...
console.log(your check is in the mail);
}
    //second if your age is equal to the retirementAge
else if (age==retirementAge){
console.log (you can recieve a check);
}
    //third if your age is younger than the retirementAge
if (age<retirementAge){
console.log (you cannot recieve a check);
}
}
//main function tests your code above with different inputs.
function main(){
    retire(18); sorry you cannot get a check
    retire(50); Wait longer
    retire(65); Almost there
    retire(100); Your check is coming in the mail//Hundo!
